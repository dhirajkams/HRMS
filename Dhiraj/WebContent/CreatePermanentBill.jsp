...
<body bgcolor=orange>
<form action="CreatePermanentBillController" method=post>
...
<tr><td><input type="submit" name=action value="Home"></td></tr>
</table>
</form>
<div>
<%
if(request.getSession().getAttribute("PermanentBillSuccess")!=null)
{
	out.print(request.getSession().getAttribute("PermanentBillSuccess"));
	request.getSession().removeAttribute("PermanentBillSuccess");
}
%>
</div>
</body>
